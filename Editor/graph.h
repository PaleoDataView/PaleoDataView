...
class Graph : public QGraphicsScene
{
    Q_OBJECT
public:
    Graph(QWidget *dialog=0,float *d=0,int c=0,int r=0);
    ~Graph();
    ...
    void setView(float x1,float x2,float y1,float y2,int n);
    void setView(float x1,float x2,float y1,float y2);
    ...
    void setColorScheme(int i,int n);
    int getColorScheme(int n);

    void setAutosize(int* as,int mode);
    void setAutosize(int* as,int mode,int n);

    float get_Min_X(int i);
    float get_Min_Y(int i);
    float get_Max_X(int i);
    float get_Max_Y(int i);
private slots:
    void transmitGraphChanged();
